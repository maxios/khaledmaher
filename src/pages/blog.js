...
const BlogPage = ({data}) => {
  return (
    <Layout seo={{title: 'Khaled Maher | Blog', description: 'thoughts made for love', image: 'https://scontent.fcai20-1.fna.fbcdn.net/v/t1.0-9/103481744_1587539261396427_7896338582725589395_n.jpg'}}>
