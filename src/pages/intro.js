...
const IntroPage = () => {
  return (
    <Layout>
      <div className="intro__header d-flex justify-content-center align-items-end">
        <Navbar/>
      </div>
        ...
        <div className="container row">
          <section className="intro__message col-md-8 col-sm-12">
            <h1 className="font__title--big">
              Hi there!, I’m <span className="font__R-medium">Khaled</span>
            </h1>

            <p className="pt-5 pr-md-3 font__message">
